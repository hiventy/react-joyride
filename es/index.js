...
var Joyride = function (_React$Component) {
    ...
    _this.handleKeyboardNavigation = function (e) {
      ...
      if (shouldRenderTooltip) {
        ...
        if (intKey === 27) {
          ...
          _this.toggleTooltip({ show: hasSteps, index: index + 1, action: 'next', direction: 1 });
        }
      }
    };
    ...
    _this.handleClickTooltip = function (e) {
      ...
      if (el.className.indexOf('joyride-') === 0) {
        ...
        if (tooltip.classList.contains('joyride-tooltip--standalone')) {
          ...
          _this.toggleTooltip({ show: shouldDisplay, index: newIndex, action: dataType, direction: dataType === 'back' ? -1 : 1 });
        }
  ...
  _createClass(Joyride, [{
    ...
    value: function toggleTooltip(_ref3) {
      ...
      var self = this;
      var delay = nextStep && nextStep.delay || false;
      if (delay && _typeof(nextStep.delay) === 'object') delay = direction === 1 ? delay[0] : delay[1];
